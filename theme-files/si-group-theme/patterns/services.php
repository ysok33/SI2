...
<section class="wp-block-group services-section" style="padding-top:80px;padding-bottom:80px">
  ...
  <div class="wp-block-group section-header" style="margin-bottom:56px">
    <!-- wp:paragraph {"style":{"typography":{"fontSize":"12px","fontWeight":"700","letterSpacing":"0.15em"},"color":{"text":"#C8A96E"}}} -->
    <p style="font-size:12px;font-weight:700;letter-spacing:0.15em;color:#C8A96E">SERVICES</p>
    <!-- /wp:paragraph -->
    <!-- wp:heading {"level":2,"style":{"spacing":{"margin":{"top":"8px"}}}} -->
  ...
  <div class="wp-block-columns">
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group service-card" style="border-radius:8px;border:1px solid #E0E0E0;padding:32px 28px;box-shadow:0 2px 12px rgba(0,0,0,0.08)">
        ...
        <p style="font-size:14px;color:#555555;margin-top:12px">労働者派遣事業許可（第33-300657）を取得。お取引先企業の業務に合った人材を派遣します。</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
    ...
    <div class="wp-block-column">
      ...
      <div class="wp-block-group service-card" style="border-radius:8px;border:1px solid #E0E0E0;padding:32px 28px;box-shadow:0 2px 12px rgba(0,0,0,0.08)">
        ...
        <!-- /wp:heading -->
        <!-- wp:paragraph {"style":{"typography":{"fontSize":"14px"},"color":{"text":"#555555"},"spacing":{"margin":{"top":"12px"}}}} -->
        <p style="font-size:14px;color:#555555;margin-top:12px">ソフトバンク株式会社・SBモバイルサービス株式会社との取引実績を持つ通信関連事業を展開しています。</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
