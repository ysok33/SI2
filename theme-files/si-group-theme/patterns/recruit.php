...
<section class="wp-block-group recruit-section has-background" style="background-color:#EEF3F8;padding-top:80px;padding-bottom:80px">
  ...
  <div class="wp-block-group">
    ...
    <!-- wp:group {"style":{"layout":{"selfStretch":"fill"},"spacing":{"margin":{"right":"64px"}}}} -->
    <div class="wp-block-group" style="margin-right:64px">
      <!-- wp:paragraph {"style":{"typography":{"fontSize":"12px","fontWeight":"700","letterSpacing":"0.15em"},"color":{"text":"#C8A96E"}}} -->
      <p style="font-size:12px;font-weight:700;letter-spacing:0.15em;color:#C8A96E">RECRUIT</p>
      <!-- /wp:paragraph -->
      <!-- wp:heading {"level":2,"style":{"spacing":{"margin":{"top":"8px","bottom":"24px"}}}} -->
      ...
      <div class="wp-block-buttons">
        <!-- wp:button -->
        <div class="wp-block-button"><a class="wp-block-button__link has-background" href="/recruit" style="background-color:#1A3A5C;color:#FFFFFF">採用情報の詳細を見る</a></div>
        <!-- /wp:button -->
      </div>
      <!-- /wp:buttons -->
    </div>
    ...
    <!-- 特徴カード -->
    <!-- wp:group {"className":"recruit-features","style":{"spacing":{"margin":{"top":"0"}}}} -->
    <div class="wp-block-group recruit-features">
